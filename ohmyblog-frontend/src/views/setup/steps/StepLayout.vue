...
<template>
    <div class="p-8 flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-2">
            ...
            <p v-if="description || $slots.description" class="text-text-icon text-sm">
        ...
        <!-- 底部按钮区域：统一的导航控制 -->
        <StepButton :loading="loading" :showPrev="showPrev" :nextDisabled="nextDisabled" :nextText="nextText"
            :prevText="prevText" @next="$emit('next')" />
    </div>
</template>

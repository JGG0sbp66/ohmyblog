...
<template>
    ...
    -->
    <svg :class="['animate-spin duration-200', props.sizeClass, props.colorClass]" xmlns="http://www.w3.org/2000/svg"
        fill="none" viewBox="0 0 24 24">
        <!-- 背景圆环 -->
        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>

        <!-- 前景圆环-->
        <circle class="spinner-path opacity-75" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"
